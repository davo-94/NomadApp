  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`id`,`email`,`password`,`role`,`username`,`firstName`,`lastName`,`enabled`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `users` SET `id` = ?,`email` = ?,`password` = ?,`role` = ?,`username` = ?,`firstName` = ?,`lastName` = ?,`enabled` = ? WHERE `id` = ?";
      }
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmpEnabled = _tmp != 0;
            _result = new User(_tmpId,_tmpEmail,_tmpPassword,_tmpRole,_tmpUsername,_tmpFirstName,_tmpLastName,_tmpEnabled);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<User> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfEnabled);
            _tmpEnabled = _tmp != 0;
            _item = new User(_tmpId,_tmpEmail,_tmpPassword,_tmpRole,_tmpUsername,_tmpFirstName,_tmpLastName,_tmpEnabled);
            _result.add(_item);
          }
          return _result;
        } finally {
