  ...
  public PostDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPost = new EntityInsertionAdapter<Post>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `posts` (`id`,`title`,`description`,`date`,`imageUri`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      public List<Post> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Post(_tmpId,_tmpTitle,_tmpDescription,_tmpDate,_tmpImageUri);
            _result.add(_item);
          }
          return _result;
        } finally {
